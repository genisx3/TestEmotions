...
getBarChart() {
    ...
    const adjustedMaxValue = maxValue > 0 ? maxValue * 1.2 : 1; // Add 20% buffer above max value
    const scaleFactor = chartHeight / adjustedMaxValue; // Use adjusted max value for scaling
